...
if __name__ == "__main__":
    ...
    for longitude in range(13, 15, 2):
        for latitude in range(51, 55, 2):
            new_L_tracks, new_L_points, new_L_dates = create_list_links(path2data + "Circles\\", longitude, latitude)
    ...
    df_tracks['tracks'] = L_tracks
    df_tracks['points'] = L_points
    df_tracks['dates'] = L_dates
    df_tracks['scraped'] = 0